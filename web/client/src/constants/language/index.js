		...
		resources: {
			en: {
				translation: {
					...
					currentDeliveryReportDetail: 'Downloads a report with, for each box, the id, the school, if it reached final destination, and if so the date of the scan',
					academicInspection: 'Ac. Insp.',
					educationAndTrainingInspection: 'Ed. & Train. Insp.',
					commune: 'Commune',
			...
			fr: {
				translation: {
					...
					currentDeliveryReport: 'Rapport de livraison',
					currentDeliveryReportDetail: 'Télécharge un rapport avec, pour chaque boîte, l\'id, l\'école, si elle a atteint sa destination finale, et si oui la date du scan',
					academicInspection: 'Insp. Ac.',
					educationAndTrainingInspection: 'Insp. E&F',
					commune: 'Commune',
			...
			wo: {
				translation: {
					...
					currentDeliveryReport: 'Taalal dokkal',
					currentDeliveryReportDetail: 'Jàmmek taalal ak ID, loxo, ak dokkal ak ko xamal',
